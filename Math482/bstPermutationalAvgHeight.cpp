...
A common Homework question involvs finding the average height of
a binary tree, based off the permutations of n numbers, where each
...
int main(){
    ...
    for (int index = 0; index < permutations; index++){
        ...
        We add this height value to the total height count.*/
        totalCount += treeHeight;
    ...
    cout << "Average Binary Tree Height of  " << n << " nodes:  " << (static_cast<double>(totalCount)) / permutations << endl;
